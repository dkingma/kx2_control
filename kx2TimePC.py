# kx2TimePC.py
# D. Kingma
# With an Elecraft KX2 connected to a PC, this script will change the KX2 time to the
# UTC time as read from your Mac clock. Install pyserial before running this script.
# Note: I'm not sure if the port.serial_number will be the same for all radios as I only had
...
for port in serial.tools.list_ports.comports():
    if port.manufacturer == 'FTDI' and port.serial_number == 'A10KN9Z1A':
